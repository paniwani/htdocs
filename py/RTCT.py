...
class RTCT(object):
  ...
  def parse(self):
    ...
    MR_image = sitk.Resample(MR_image, self.CT_image, transform, sitk.sitkLinear, -1000, sitk.sitkFloat32)
    ...
    MR_image = sitk.Cast(sitk.IntensityWindowing(MR_image, -380, 420, 0, 255), sitk.sitkUInt8)
